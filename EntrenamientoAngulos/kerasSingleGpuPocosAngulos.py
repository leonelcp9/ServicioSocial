...
model = tf.keras.models.Sequential([
    tf.keras.layers.Conv2D(96,(5,5),strides=(2, 2),activation='relu',input_shape=(48,48,3)),
   # tf.keras.layers.Conv2D(96,(5,5),strides=(2, 2),activation='relu'),
   # tf.keras.layers.Conv2D(96,(5,5),strides=(2, 2),activation='relu'),  
...
tf.keras.utils.plot_model(model, to_file='modeloAngulo.png')
...
plt.ylabel('loss')
plt.xlabel('Epoch')
plt.legend(['Training loss', 'Validations loss'], loc='upper right')
#plt.show()
